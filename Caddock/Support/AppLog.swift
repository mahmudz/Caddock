...
enum LogFiles {
    static func directoryURL() throws -> URL {
        ...
        ).appendingPathComponent("Logs/Caddock", isDirectory: true)
...
struct AppLogger {
    ...
    init(category: String) {
        ...
        self.osLogger = Logger(subsystem: HelperConstants.appBundleIdentifier, category: category)
    }
...
enum AppLog {
    ...
    private static let queue = DispatchQueue(label: "dev.mahmudz.Caddock.AppLog")
