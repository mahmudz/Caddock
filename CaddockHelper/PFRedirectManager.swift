...
enum PFRedirectManager {
    ...
    private static let pfConfBackupPath = "/etc/pf.conf.caddock.bak"
    ...
    private static let rdrMarkerBegin = "# BEGIN Caddock pf rdr"
    private static let rdrMarkerEnd = "# END Caddock pf rdr"
    private static let loadMarkerBegin = "# BEGIN Caddock pf load"
    private static let loadMarkerEnd = "# END Caddock pf load"
    ...
    private static func ensurePFConfAnchorPoint() throws -> Bool {
        ...
        let tempPath = pfConfPath + ".caddock.tmp"
