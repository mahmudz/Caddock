        ...
        VStack(spacing: 0) {
            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                if needsHelperApproval {
                    Text("Enable CaddyManager under System Settings → General → Login Items & Extensions → Background Items, then tap Check Again.")
                        .font(.caption)
...
#Preview {
    let suite = "dev.mahmudz.CaddyManager.setup-preview"
